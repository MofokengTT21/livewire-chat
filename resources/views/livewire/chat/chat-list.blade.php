                        ...
                        <div class="flex gap-x-2 items-center">
                            ...
                            {{-- <span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    ...
                                    <path d="M13.854 2.146a.5.5 0 0 0-.708 0l-7 7-3.5-3.5a.5.5 0 1 0-.708.708l4 4a.5.5 0 0 0 .708 0l8-8a.5.5 0 0 0 0-.708z" />
                                </svg>
                            </span>                             --}}


                            <p class="grow truncate text-sm font-[100]">
                                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Reiciendis, deserunt excepturi.
                            </p>
                        ...
                        <x-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                <button>
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        fill="currentColor" class="bi bi-three-dots-vertical w-6 h-6 text-gray-700"
                                        viewBox="0 0 16 16">
                                        <path
