<div class="fixed h-full flex bg-white overflow-hidden inset-0 lg:top-16 lg:inset-x-2 m-auto lg:h-[90%] rounded-t-lg">

    <div class="relative w-full md:w-[360px] xl:w-[400px] overflow-y-auto shrink-0 h-full">
