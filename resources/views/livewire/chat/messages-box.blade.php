...
class="w-full h-full flex flex-col overflow-hidden">
    ...
    <div class="flex flex-col overflow-y-scroll grow h-full">
        ...
        <header class="w-full sticky inset-x-0 flex pb-[5px] pt-[5px] top-0 z-10 bg-white border-b ">
            ...
            <div class="flex w-full items-center px-2 lg:px-4 gap-2 md:gap-5">
                ...
                <a class="shrink-0 lg:hidden" href="{{ url('/chat') }}">
        ...
        <main
            ...
            <div @class([
                ...
                <div class="flex flex-wrap flex-col">
                    ...
                    'rounded-br-[3px] bg-gradient-to-tr from-[#FF61D2] to-[#FE9090] text-white' => $message->sender_id=== auth()->id(),
                ])
                   >
                        {{$message->body}}
                    </p>
        ...
        <footer class="shrink-0 z-10 bg-white inset-x-0">
            ...
            <div class=" p-2 border-t">
                ...
                method="POST" autocapitalize="off">
                    ...
                    <div class="grid grid-cols-[15fr_0.5fr] items-center gap-2">
                        <input 
                            x-model="body"
                            type="text" 
                            autocomplete="off" 
                        ...
                        <button x-bind:disabled="!body.trim()" class="flex justify-center" type='submit'><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#6b7280" class="bi bi-send text-center" viewBox="0 0 16 16">
